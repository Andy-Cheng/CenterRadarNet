...
from .buildingblocks import DoubleConv, ResNetBlock, create_encoders, \
    create_decoders
...
class AbstractUNet(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, basic_module, f_maps=64, layer_order='gcr',
                 ...
                 conv_padding=1, is3d=True, name='AbstractUNet'):
...
class ResidualUNet3D(AbstractUNet):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid=True, f_maps=64, layer_order='gcr',
        ...
        super(ResidualUNet3D, self).__init__(in_channels=in_channels,
                                             ...
                                             f_maps=f_maps,  # todo: check
                                             layer_order=layer_order, # todo: check
                                             num_groups=num_groups, # todo: check
                                             num_levels=num_levels, # todo: chck
                                             is_segmentation=is_segmentation, # todo: check
                                             conv_padding=conv_padding,
                                             is3d=True)
