...
DATASET = dict(
  DIR=dict(
    ...
    START_END_FILE='/mnt/ssd3/CRUW3D/labels/cruw22_seq_start_end.json'
  ),
...
test_cfg = dict(
    ...
    app_emb_save_path='/mnt/nas_cruw_pose_2/CRUW3D_EMB/triplet_l2' # inside are seq folders
)
...
# optimizer
# optimizer = dict(
#     type="Adam", lr=0.002, amsgrad=False, weight_decay=0.01
# )
# lr_config = dict(
#     type="MULTISTEPLR", drop_step=[20, 25], gamma=0.1
# )
optimizer = dict(
